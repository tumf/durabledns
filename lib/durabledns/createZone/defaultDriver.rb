require 'durabledns/createZone/default.rb'
require 'durabledns/createZone/defaultMappingRegistry.rb'
require 'soap/rpc/driver'

class CreateZonewsdlPortType < ::SOAP::RPC::Driver
  DefaultEndpointUrl = "https://durabledns.com:443/services/dns/createZone.php"
  NsCreateZonewsdl = "urn:createZonewsdl"

  Methods = [
    [ XSD::QName.new(NsCreateZonewsdl, "createZone"),
