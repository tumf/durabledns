...
obj = CreateZonewsdlPortType.new(endpoint_url)

# run ruby with -d to see SOAP wiredumps.
obj.wiredump_dev = STDERR if $DEBUG

# SYNOPSIS
#   createZone(apiuser, apikey, zonename, ns, mbox, refresh, v_retry, expire, minimum, ttl, xfer, update_acl)
#
# ARGS
...
puts obj.createZone(apiuser, apikey, zonename, ns, mbox, refresh, v_retry, expire, minimum, ttl, xfer, update_acl)
